...
#Ex2:
radius = 30
#a) Calculate the area of a circle and assign the value to a variable named area_of_circle
area_of_circle = 3.14 * radius ** 2
print(area_of_circle)
#b) Calculate the circumference of a circle and assign the value to a variable named circum_of_circle
